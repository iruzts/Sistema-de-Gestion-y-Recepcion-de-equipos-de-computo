                ...
                <tr>
                    ...
                    <th>
                        <button class="btn btn-default text-primary mx-1" href="" data-toggle="modal"
                            data-target="#modaleditarequipo{{ $tipoequipo->id }}"> <i class="fa fa-lg fa-fw fa-pen"></i>
                        </button>
                        @include('tipoequipo.modal.update')
                        <form action="{{ route('tipoequipo.destroy', $tipoequipo->id) }}" method="post"
...
<div class="modal fade" id="modalcrearequipos" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
