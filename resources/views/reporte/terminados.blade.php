    ...
    <div class="row mb-2">
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-left">
                ...
                <li class="breadcrumb-item active">Equipos Terminados</li>
            </ol>
        </div>
        <div class="col-sm-6">
            <a type="button" class="btn btn-primary float-right btn-sm mr-1" href="{{ route('terminadospdf') }}" target="_blank">
